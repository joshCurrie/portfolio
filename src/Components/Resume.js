...
class Resume extends Component {
  ...
  render() {
    ...
    if(this.props.data){
      ...
      return <div key={internships.company}><h3>{internships.company}</h3>
          <p className="info">{internships.title}<span>&bull;</span> <em className="date">{internships.years}</em></p>
